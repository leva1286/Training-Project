...
import com.gordietsdev.a23_6recyclerviewscroll.R
...
class ProductDelegateAdapter : AbsListItemAdapterDelegate<Product, Item, ProductDelegateAdapter.ViewHolder>() {
